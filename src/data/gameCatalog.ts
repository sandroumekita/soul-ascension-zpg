...
export const SKILLS_CATALOG: SkillData[] = [
  // Slot 1: Habilidades Rápidas (Hadō / Spells)
  {
    id: 'getsuga_tensho',
    name: 'Getsuga Tenshō',
  ...
  },
  {
    ...
    slotType: 1,
    rarity: 'transcendent',
    description: 'Golpe fulminante no ponto vital que aniquila o alvo principal com dano massivo.',
    cooldownSec: 16.0,
    damageMultiplier: 14.0,
  },
  ...
  // Slot 2: Bankai / Ultimates
  {
    ...
    slotType: 2,
    rarity: 'epic',
    description: 'Fúria negra: Dobra o ATK e rouba 8% de vida em todos os ataques.',
    cooldownSec: 26.0,
    durationSec: 8.0,
  ...
  },
  {
    ...
    slotType: 2,
    rarity: 'legendary',
    description: 'Nuvem de 1.000 lâminas cortando a horda e concedendo +50% Vel. de Ataque por 6s.',
    cooldownSec: 28.0,
    durationSec: 6.0,
  ...
  },
  {
    ...
    slotType: 2,
    rarity: 'transcendent',
    description: 'Chamas do sol que incineram a tela e aumentam o ATK em +80% por 5s.',
    cooldownSec: 42.0,
    durationSec: 5.0,
